...
Example Usage:
    ...
    from src.cleaners import _types as types
    log = types.ChangeLog()

Notes:
 - These types are internal implementation details of the cleaners package.
...
class ChangeLog:
    ...
    def to_frozen_list(self) -> tuple[str, ...]:
        """
