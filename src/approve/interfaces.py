"""
Public interfaces for the `approve` package.
...
# noinspection PyProtectedMember
from src.approve._header import (
    model_number,
    board_name,
    board_supplier,
    build_stage,
...
# noinspection PyProtectedMember
from src.approve._logic import (
    quantity_zero,
    designator_required,
    designator_count,
