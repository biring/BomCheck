...
class TestInterface(unittest.TestCase):
    ...
    cases = (
        ...
        (coerce.board_supplier, bfx.HEADER_A.manufacturer),
        (coerce.build_stage, bfx.HEADER_A.build_stage),
        (coerce.bom_date, bfx.HEADER_A.date),
        ...
        (coerce.units, bfx.ROW_A_1.unit),
        (coerce.classification, bfx.ROW_A_1.classification),
        (coerce.manufacturer, bfx.ROW_A_1.manufacturer),
        ...
        (coerce.designator, bfx.ROW_A_1.designator),
